...
describe("Bonus Quest - greatestProduct", () => {
  ...
  it("should return 32000 with the provided example", () => {
    let matrix = [
      [1, 2, 3, 4, 1],
      [1, 2, 3, 4, 20],
      [1, 2, 3, 4, 20],
...
describe("Bonus Quest - greatestProductDiagonal", () => {
  ...
  it("should return 1 (one) when all numbers of the arrays are 1", () => {
    ...
    expect(greatestProductDiagonal(matrix)).toBe(1);
  });
  ...
  it("should return 16 when all the numbers of the arrays are 2", () => {
    ...
    expect(greatestProductDiagonal(matrix)).toBe(16);
  });
  ...
  it("should return 32000 with the provided example", () => {
    ...
    expect(greatestProductDiagonal(matrix)).toBe(32000);
  });

  it("should return 100000000 with the provided example", () => {
    let matrix = [
      [1, 2, 3, 4, 5],
      [1, 20, 3, 100, 5],
      [1, 0, 100, 4, 5],
    ...
    expect(greatestProductDiagonal(matrix)).toBe(100000000);
  });
});
